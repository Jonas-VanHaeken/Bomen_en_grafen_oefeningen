...
public abstract class BinaryTree<E> {
	...
	protected BinaryTree<E> rightTree;
	...
	protected abstract E searchGreatest();

	protected abstract boolean removeNode(E grootsteLinks);

	protected abstract void cleanUp();

	protected abstract E searchSmallest();

	protected abstract ArrayList<E> getPath(E data);
}
